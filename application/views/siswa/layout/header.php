    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url()?>siswa/dashboard"><img src="<?php echo base_url()?>assets/img/logo-main-navbar.png"></a>
        </div>
        <div class="navbar-collapse collapse navbar-right">
          <ul class="nav navbar-nav">
            <li><a href="<?php echo base_url()?>siswa/dashboard">HOME</a></li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="<?php echo base_url()?>siswa/profil">PROFIL</a></li>
                <li><a href="<?php echo base_url()?>siswa/logout">LOGOUT</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
